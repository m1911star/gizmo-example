...
export class EditControl {
    ...
    public constructor(mesh: TransformNode, camera: Camera, canvas: HTMLCanvasElement, scale?: number, eulerian?: boolean, pickWidth?: number) {
        ...
        this._pointerdown = (evt) => {
            return this._onPointerDown(evt)
        };
        this._pointerup = (evt) => {
            return this._onPointerUp(evt)
        };
        this._pointermove = (evt) => {
            return this._onPointerMove(evt)
        };
        ...
        this._renderer = () => {
            return this._renderLoopProcess()
        };
    ...
    private _onPointerDown(evt: Event) {
        ...
        if (pickResult.hit) {
            ...
            window.setTimeout(((cam, can) => {
                return this._detachCamera(cam, can)
            }), 0, this._mainCamera, this._canvas);
        }
    }
